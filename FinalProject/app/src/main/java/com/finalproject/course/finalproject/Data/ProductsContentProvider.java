...
public class ProductsContentProvider extends ContentProvider {
    private static  final String AUTHORITY = "com.finalproject.course.Data.ProductsContentProvider";
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
       ...
       switch (uriMatcher.match(uri)) {
        ...
        if(!TextUtils.isEmpty(sortOrder)){
            sortOrder = SharingInfoContract.ProductsEntry.DATE_MODIFIED + " DESC"; //Sort by modified date as default
        }
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        if (rowID > 0) {
            return ContentUris.withAppendedId(PRODUCTS_CONTENT_URI, rowID);
        }
