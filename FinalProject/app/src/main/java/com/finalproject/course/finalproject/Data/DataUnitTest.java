...
public class DataUnitTest {
    ...
    public void testInsertProducts(Context cnx) {
        ...
        values.put(SharingInfoContract.ProductsEntry.DATE_MODIFIED, DateFormat.format("dd-MM-yyyy hh:mm:ss",new java.util.Date()).toString());
    ...
    public int getProductList(Context cnx) {
        return cnx.getContentResolver().delete(
                ContentUris.withAppendedId(ProductsContentProvider.PRODUCTS_CONTENT_URI, rowID),
                null,
                null);
